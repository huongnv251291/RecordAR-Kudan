...
public class GameRecorder {
    static final float ARENA_WIDTH = 1080.0f;
    static final float ARENA_HEIGHT = 1920.0f;
    ...
    public void prepareEncoder(Context context) {
        ...
        mOutputFile = new File("/sdcard/videotex.mp4");
...
//        }
    ...
    public boolean isRecord() {
        return !(mInputSurface == null || mMuxer == null || mEncoder == null || mOutputFile == null);
    }
}
