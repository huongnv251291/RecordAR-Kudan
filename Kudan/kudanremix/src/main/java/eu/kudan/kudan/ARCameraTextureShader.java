...
public class ARCameraTextureShader extends ARShaderProgram {
    ...
    public static ARCameraTextureShader getShader() {
        ...
        ARCameraTextureShader shader = (ARCameraTextureShader)shaderManager.findShader(ARCameraTextureShader.class, properties);
        if(shader != null) {
            return shader;
        } else {
            shader = new ARCameraTextureShader();
    ...
    public void setUVTransform(float[] uvTransform) {
        ...
        if(uvTransformHandle >= 0 && uvTransform != null) {
